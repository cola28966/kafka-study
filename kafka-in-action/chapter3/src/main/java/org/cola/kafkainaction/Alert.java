...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The allowed values that our sensors will use to emit current status */
   private org.cola.kafkainaction.AlertStatus status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, org.cola.kafkainaction.AlertStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (org.cola.kafkainaction.AlertStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.cola.kafkainaction.AlertStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(org.cola.kafkainaction.AlertStatus value) {
    this.status = value;
  }
   ...
   */
  public static org.cola.kafkainaction.Alert.Builder newBuilder() {
    return new org.cola.kafkainaction.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static org.cola.kafkainaction.Alert.Builder newBuilder(org.cola.kafkainaction.Alert.Builder other) {
    if (other == null) {
      return new org.cola.kafkainaction.Alert.Builder();
    } else {
      return new org.cola.kafkainaction.Alert.Builder(other);
    }
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static org.cola.kafkainaction.Alert.Builder newBuilder(org.cola.kafkainaction.Alert other) {
    if (other == null) {
      return new org.cola.kafkainaction.Alert.Builder();
    } else {
      return new org.cola.kafkainaction.Alert.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.cola.kafkainaction.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.cola.kafkainaction.Alert other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder setStatus(org.cola.kafkainaction.AlertStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.cola.kafkainaction.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (org.cola.kafkainaction.AlertStatus) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = org.cola.kafkainaction.AlertStatus.values()[in.readEnum()];
